...
// NewRabbitDelay url -> "amqp://guest:guest@127.0.0.1:5672/"
func NewRabbitDelay(url string) DelayQueue {
	return NewDelayQueue(url)
}

// NewRabbitCom url -> "amqp://guest:guest@127.0.0.1:5672/"
func NewRabbitCom(url string) CommonQueue {
	return NewCommonQueue(url)
}
